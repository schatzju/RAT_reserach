...
./a.out f 4 hbc_single_trash_8_26_18 $OUTPUT_NAME "smem --set spreading-use-only both"
./a.out f 4 hbc_single_trash_8_26_18 $OUTPUT_NAME_NO_FAN "smem --set spreading-use-only association"

./a.out f 4 hbc_single_8_26_18 $OUTPUT_NAME "smem --set spreading-use-only both"
./a.out f 4 hbc_single_8_26_18 $OUTPUT_NAME_NO_FAN "smem --set spreading-use-only association"
#./a.out f 4 hbc_single_trash_8_26_18 $OUTPUT_NAME_NO_ASSOC "smem --set spreading-use-only fan"
#./a.out f 4 hbc_single_trash_8_26_18 $OUTPUT_NAME "smem --set spreading-use-only both"
